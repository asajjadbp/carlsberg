...
import 'package:carlsberg/UI_Screen/survey/survey_screen5.dart';
...
class SurveyScreen4 extends StatefulWidget {
  const SurveyScreen4({super.key,required this.surveyQuestionList,required this.storeId,required this.surveyName});
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("5: ${widget.surveyQuestionList[4].question}"),
                  ...
                  NextPreviousButtons(
                    ...
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=> SurveyScreen5(storeId: widget.storeId,surveyQuestionList: widget.surveyQuestionList,surveyName: widget.surveyName,)));
                  },prevOnTap: (){
