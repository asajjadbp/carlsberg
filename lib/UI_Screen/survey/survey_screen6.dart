...
import 'package:carlsberg/UI_Screen/survey/survey_screen7.dart';
...
class SurveyScreen6 extends StatefulWidget {
  const SurveyScreen6({super.key,required this.surveyQuestionList,required this.storeId,required this.surveyName});
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("7: ${widget.surveyQuestionList[6].question}"),
                  ...
                  NextPreviousButtons(
                    ...
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=> SurveyScreen7(storeId: widget.storeId,surveyQuestionList: widget.surveyQuestionList,surveyName: widget.surveyName,)));
                  },prevOnTap: (){
